...
namespace Data
{
    [CreateAssetMenu(fileName = "Bullets Data", menuName = "Game Data/Bullets Data")]
    public class BulletData : ScriptableObject, IEnumerable<BulletData.Item>
    {
        ...
        public Item GetBullet(int index)
        {
            try
            {
        ...
        public class Item : ItemBase
        {
            ...
            public GameObject CatapultPrefab => catapult;
        ...
        private void OnValidate()
        {
            ...
            {
                cost.Initialize($"bullets_base_{baseCosts.IndexOf(cost)}");
            }
            ...
            {
                cost.Initialize($"bullets_premium_{premiumCosts.IndexOf(cost)}");
            }
        }
